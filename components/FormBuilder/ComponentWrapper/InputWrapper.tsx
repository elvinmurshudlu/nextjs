...
function ComponentWrapper({className,children,fieldName,label,dependOn}:PropsWithChildren<IFormComponent>) {
    ...
    useEffect(()=>{
        if(dependedValuesString!== initialDependedValue.current && initialDependedValue.current !==''){
    ...
    return (
        <div className={clsx(className,'flex flex-col gap-2 items-start')} >
